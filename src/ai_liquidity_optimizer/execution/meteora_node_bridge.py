    ...
    def get_onchain_snapshot(
        ...
        *,
        ...
        snapshot: dict[str, Any] = {
            ...
            "pool_user_positions": result.get("pool_user_positions"),
            "pool_user_position_count": result.get("pool_user_position_count"),
            "pool_user_position_pubkeys": result.get("pool_user_position_pubkeys"),
            "pool_other_position_count": result.get("pool_other_position_count"),
            "pool_other_position_pubkeys": result.get("pool_other_position_pubkeys"),
            "tracked_position_pubkey": result.get("tracked_position_pubkey"),
            "tracked_position_detected": result.get("tracked_position_detected"),
            "pool_user_positions_error": result.get("pool_user_positions_error"),
